      ...
      >
          ...
          >
              <div 
                ...
                onClick={(e) => {
                    // Previene que el click se propague al trigger del collapsible
                    // si el click no es directamente en el trigger
                            ...
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <CollapsibleTrigger asChild>
                                        <Button variant="ghost" size="icon" className="h-6 w-6 shrink-0 cursor-pointer" data-collapsible-trigger>
